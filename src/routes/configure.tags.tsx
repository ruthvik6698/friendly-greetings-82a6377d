...
export const Route = createFileRoute("/configure/tags")({
  component: TagsPage,
});
      ...
      <div className="mx-auto max-w-4xl px-8 py-10">
        <div className="mb-6 flex items-start justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Manage content tags. Sensitive tags require human approval before the agent can use that content.</p>
          </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">Content tagged as &quot;sensitive&quot; won&apos;t be shared by the agent until a human reviews and approves it.</p>
              </div>
            </div>
          </CardContent>
        </Card>
