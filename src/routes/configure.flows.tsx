...
export const Route = createFileRoute("/configure/flows")({
  component: FlowsPage,
});
      ...
      <div className="mx-auto max-w-4xl px-8 py-10">
        <div className="mb-6 flex items-start justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Design step-by-step conversation flows. Each flow handles one intent with inform, collect, and action steps.</p>
          </div>
